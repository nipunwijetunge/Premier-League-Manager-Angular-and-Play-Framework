...
public class SchoolFootballClub extends FootballClub {
    ...
    public SchoolFootballClub(String clubName, String clubLocation, int wins, int draws, int defeats, int goalsReceived, int goalsScored, int points, int numberOfMatchesPlayed, String schoolName) {
